...
function FocusTimer() {
  ...
  }, [isRunning, timeLeft, duration, addSession, sendNotification]);
  ...
  }, [duration, timeLeft, circumference]);
  ...
  return (
    <section className="mt-8">
      ...
      <Card className="max-w-5xl mx-auto relative overflow-hidden">
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-purple-500/5 blur-3xl"
        />
        ...
        <div className="relative z-10">
          <div className="flex justify-center">
            <div className="relative">
              <svg
                aria-hidden="true"
                className="w-57.5 h-57.5 sm:w-75 sm:h-75"
                viewBox="0 0 300 300"
              >
                <circle
                  cx="150"
              ...
              >
                <span className="text-5xl sm:text-6xl font-bold theme-text">
                  {formatTime(timeLeft)}
                </span>

                <span className="theme-text-muted mt-2">Remaining</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center gap-3 mt-8 flex-wrap">
            <Button
              ...
              onClick={() => selectPreset(TWENTY_FIVE)}
            >
              25 min
            </Button>
            ...
            <Button
              type="button"
              variant="secondary"
              aria-label="Set timer to 50 minutes"
              onClick={() => selectPreset(FIFTY)}
            >
              50 min
            </Button>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 mt-6">
            <label htmlFor="custom-focus-time" className="sr-only">
            ...
            <input
              ...
              className="w-full sm:w-auto theme-input rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-purple-500/50"
              value={customMinutes}
